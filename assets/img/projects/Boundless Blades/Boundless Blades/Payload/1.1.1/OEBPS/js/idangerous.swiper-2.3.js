...
*/
var Swiper23 = function (selector, params) {
    /*=========================
    ...
    function onTouchMove(event) {
        ...
        //hack PubCoder
        // if (pageX > window.innerWidth || pageX < window.pageXOffset) {
...
Swiper23.prototype = {
    ...
    browser : {
        ...
        // PubCoder ADD: exclude ie11+
        ie10 : window.navigator.msPointerEnabled && navigator.userAgent.match(/MSIE/) && (!!navigator.userAgent.match(/Trident/))
...
if (window.jQuery||window.Zepto) {
    (function($){
        $.fn.swiper = function(params) {
            var s = new Swiper23($(this)[0], params)
            $(this).data('swiper',s);
            return s;
        }
