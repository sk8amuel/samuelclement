document.addEventListener('DOMContentLoaded',function(){
  ...
  function goAbout(){ if(navAbout){ navAbout.click(); } else { try{ location.hash='#about'; }catch(_){ location.href='index.html#about'; } } }
  function goIndex(){ if(navIndex){ navIndex.click(); } else { try{ if(location.hash){ history.replaceState(null,'',location.pathname); } }catch(_){} location.href='index.html'; } }
